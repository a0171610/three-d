...
SRC = math_module.f90 planet_module.f90 lsqrblas.f90 lsqr.f90 \
	...
	polint_module.f90 bicubic_module.f90 tricubic_module.f90 direction_module.f90 new_diagram_module.f90 \
...
main.o : grid_module.o time_module.o semilag_module.o analysis_module.o new_diagram_module.o
