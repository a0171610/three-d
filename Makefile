...
SRC = math_module.f90 planet_module.f90 lsqrblas.f90 lsqr.f90 \
	...
	sphere_module.f90  field_module.f90 analysis_module.f90 direction_module.f90 direction_2step_module.f90 mass_module.f90 main.f90
OBJ = ${SRC:.f90=.o}
TARGET=adv
...
direction_2step_module.o : grid_module.o time_module.o legendre_transform_module.o upstream_module.o sphere_module.o field_module.o mass_module.o lsqr.o
...
main.o : grid_module.o time_module.o euler_module.o semilag_module.o nisl_module.o nisl_2step_module.o field_module.o analysis_module.o direction_module.o direction_2step_module.o
